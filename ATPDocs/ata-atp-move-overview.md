...
Saiba mais sobre as diferenças entre o ATA e o ATP do Azure nas [perguntas frequentes sobre o ATP do Azure](atp-technical-faq.md#what-is-azure-atp).
...
- Verifique se seus controladores de domínio atendem a todos os [requisitos de sensor do ATP do Azure](atp-prerequisites.md#azure-atp-sensor-requirements) e seu ambiente atende a todos os [requisitos do ATP do Azure](atp-prerequisites.md).
...
1. Detalhes de conta da sua conta dos [Serviços de Diretório](install-atp-step2.md).
...
1. Detalhes de conta para contas HoneyToken.
    - Se você ainda não tiver contas HoneyToken dedicadas, saiba mais sobre [HoneyTokens no ATP do Azure](install-atp-step7.md) e crie contas a serem usadas para essa finalidade.
...
1. [Criar sua instância do ATP do Azure](install-atp-step1.md)
...
1. Instale o sensor do ATP do Azure em todos os controladores de domínio:
    - [Baixe arquivos de sensor do ATP do Azure](install-atp-step3.md).
    - [Recupere sua chave de acesso do ATP do Azure](install-atp-step3.md#download-the-setup-package).
    - [Instale os sensores do ATP do Azure em seus controladores de domínio](install-atp-step4.md).

### <a name="step-2-configure-and-validate-azure-atp-instance"></a>Etapa 2: Configurar e validar instância do ATP do Azure

- [Configurar o sensor](install-atp-step5.md)
...
| 2  | Detalhes de conta dos [Serviços de Diretório](install-atp-step2.md)| - [ ] |
| 3  | Configurar [notificações do Syslog](setting-syslog.md) | - [ ] |
| 4  | Informações sobre [Integrar VPN](install-atp-step6-vpn.md)| - [ ] |
| 5  | Configurar a [integração do WDATP](integrate-wd-atp.md)| - [ ] |
| 6  | Definir contas [HoneyTokens](install-atp-step7.md)| - [ ] |
...
| 11  | Configurar [permissões baseadas em funções](atp-role-groups.md) | - [ ] |
...
- Examine os [alertas de integridade](atp-health-center.md) em busca de sinais de problemas de serviço.
- Examine os [logs de erros do sensor](troubleshooting-atp-using-logs.md) do ATP do Azure quanto a erros incomuns.
...
Saiba mais sobre os recursos, a funcionalidade e os [alertas de segurança](what-is-atp.md) do [ATP do Azure](understanding-security-alerts.md).
