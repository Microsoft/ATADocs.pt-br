...
ms.locfileid: "71007435"
---
# <a name="security-assessment-unsecure-kerberos-delegation---preview"></a>Avaliação de segurança: Delegação de Kerberos não segura – versão prévia
