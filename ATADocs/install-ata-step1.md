...
4. Se o Microsoft .NET Framework não estiver instalado, você será solicitado a instalá-lo quando iniciar a instalação. Você pode ter que reinicializar após a instalação do .NET Framework.
...
2.  Na área de trabalho, clique no atalho do **Microsoft Advanced Threat Analytics** para conectar-se ao console do ATA. Faça logon com as credenciais de usuário que você usou para instalar o ATA Center.
