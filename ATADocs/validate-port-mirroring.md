...
1. Execute esse script no Gateway do ATA que você deseja validar.
...
1. Se você vir somente o tráfego em uma direção, você deve trabalhar com as equipes de rede ou de virtualização para ajudar a solucionar os problemas de sua configuração de espelhamento de porta.
