...
# Referência de log do SIEM do ATA
...
## Atividades suspeitas do ATA de exemplo em formato CEF
...
### Replicação suspeita de serviços de diretório
...
### Credenciais de conta confidenciais expostas
...
### Serviços expondo credenciais de conta
