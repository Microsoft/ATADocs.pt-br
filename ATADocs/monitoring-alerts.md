...
ms.reviewer: elofek
ms.suite: ems
ms.openlocfilehash: 3e022ea7bcdaae20eb6a378451e3853546d3dad9
ms.sourcegitcommit: 8c0222dc8333b5aa47430c5daee9bc7f1d82df31
ms.translationtype: MT
ms.contentlocale: pt-BR
ms.lasthandoff: 04/16/2020
ms.locfileid: "81524864"
---
...
|Alerta|Descrição|Resolução|Severity|
|----|----|----|----|
...
|Alerta|Descrição|Resolução|Severity|
|----|----|----|----|
|O ATA falhou ao enviar eventos para o SIEM especificado.|Isso significa que o centro do ATA não pode enviar atividades suspeitas e alertas de integridade para o SIEM.|Certifique-se de que suas [configurações do servidor Syslog estão definidas corretamente](setting-syslog-email-server-settings.md).|Baixo|
