...
### <a name="ata-center-running-out-of-disk-space"></a>Centro do ATA ficando sem espaço em disco
...
### <a name="failure-sending-mails"></a>Falha no envio de emails
|Alerta|Descrição|Resolução|Severidade|
|----|----|----|----|
...
### <a name="ata-center-overloaded"></a>Centro do ATA sobrecarregado
|Alerta|Descrição|Resolução|Severidade|
|----|----|----|----|
...
### <a name="ata-center-certificate-is-about-to-expire"></a>Um certificado do Centro do ATA está prestes a expirar
|Alerta|Descrição|Resolução|Severidade|
|----|----|----|----|
...
### <a name="read-only-user-password-is-about-to-expire"></a>A senha do usuário somente leitura está prestes a expirar
|Alerta|Descrição|Resolução|Severidade|
|----|----|----|----|
...
### <a name="ata-gateway-certificate-about-to-expire"></a>Certificado do Gateway do ATA prestes a expirar
|Alerta|Descrição|Resolução|Severidade|
|----|----|----|----|
...
### <a name="ata-gateway-certificate-expired"></a>O certificado do Gateway do ATA expirou
|Alerta|Descrição|Resolução|Severidade|
|----|----|----|----|
...
### <a name="allsome-of-the-capture-network-adapters-on-an-ata-gateway-are-not-available"></a>Todos ou alguns dos adaptadores de rede de captura em um Gateway do ATA não estão disponíveis
|Alerta|Descrição|Resolução|Severidade|
|----|----|----|----|
...
### <a name="some-domain-controllers-are-unreachable-by-a-ata-gateway"></a>Alguns controladores de domínio estão inacessíveis por um Gateway do ATA
|Alerta|Descrição|Resolução|Severidade|
|----|----|----|----|
...
### <a name="all-domain-controllers-are-unreachable-by-a-ata-gateway"></a>Todos os controladores de domínio estão inacessíveis por um Gateway do ATA
|Alerta|Descrição|Resolução|Severidade|
|----|----|----|----|
...
### <a name="ata-gateway-stopped-communicating"></a>O Gateway do ATA interrompeu a comunicação
|Alerta|Descrição|Resolução|Severidade|
|----|----|----|----|
...
### <a name="ata-gateway-version-outdated"></a>Versão do Gateway do ATA desatualizada
|Alerta|Descrição|Resolução|Severidade|
|----|----|----|----|
...
### <a name="ata-gateway-service-failed-to-start"></a>Falha ao iniciar o serviço de Gateway do ATA
|Alerta|Descrição|Resolução|Severidade|
|----|----|----|----|
...
### <a name="lightweight-ata-gateway-reached-a-memory-resource-limit"></a>O Gateway Lightweight do ATA atingiu o limite de um recurso de memória
|Alerta|Descrição|Resolução|Severidade|
|----|----|----|----|
